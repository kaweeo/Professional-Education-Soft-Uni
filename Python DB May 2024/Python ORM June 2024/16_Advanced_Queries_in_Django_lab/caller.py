...
def product_quantity_ordered():  # anotate()
    # Get total quantity ordered for available products
    total_quantity_ordered = (
        Product.objects.available_products()
...
# 03. Ordered Products Per Customer                                                     # prefetch_related
