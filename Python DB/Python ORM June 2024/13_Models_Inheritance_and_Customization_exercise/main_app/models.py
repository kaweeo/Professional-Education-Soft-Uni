...
class MaskedCreditCardField(models.CharField):
    def __init__(self, *args, **kwargs):
        kwargs["max_length"] = 20  # Overwriting
...
class BaseReservation(models.Model):
    ...
    def is_available(self) -> bool:
        # Getting the instance of the class, not the base class with __class__
        # because base class dont have a table (db) .
