...
class Meal(models.Model):
    ...
    meal_type = models.CharField(max_length=10, choices=choices.MealTypeChoice)
...
class Dungeon(models.Model):
    name = models.CharField(max_length=100)
    difficulty = models.CharField(max_length=10, choices=choices.DungeonDifficultyChoice)
...
class Workout(models.Model):
    ...
    workout_type = models.CharField(max_length=20, choices=choices.WorkoutTypeChoice)
...
class Laptop(models.Model):
    brand = models.CharField(max_length=20, choices=choices.LaptopBrandChoice)
    ...
    operation_system = models.CharField(max_length=20, choices=choices.OperationSystemChoice)
    price = models.DecimalField(max_digits=10, decimal_places=2)
