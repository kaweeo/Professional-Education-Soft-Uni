# Generated by Django 5.0.4 on 2024-08-03 12:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=15, unique=True, validators=[django.core.validators.RegexValidator(message='Phone number must contain only digits and be up to 15 characters long.', regex='^\\d{1,15}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commander', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='missions_as_commander', to='main_app.astronaut')),
